...
function focusRosterPokemon(id){
...
function mobileBottomNav(){
  ...
  const items=[['dashboard','⌂','Home'],['trainer','🪪','Trainer'],['rosters','◉','Rosters'],['inventory','🎒','Items']];
...
function builderResetForm(definition=null){
  ...
  pokemonBuilderState.form={
    ...
    allocations:blankPokemonAllocations(),selectedAbilities:firstBasic?[firstBasic.name||firstBasic.ability_id]:[],selectedMoves:[],gmMoves:[],moveLimitModifier:0,baseFormId:'base',manualFormApprovals:[]
  };
