...
Generated from the project’s supplied PTU data packs. This is an audit inventory; bundled/default packs are not modified by this report.
...
| Species | Form | Type | Added Ability | Extra effect | Stat changes | Source page |
|---|---|---|---|---|---|---:|
...
| Swampert | Mega | Unchanged | Swift Swim | — | Atk +4, Def +2, Sp.Atk +1, Sp.Def +2, Speed +1 | 72 |
| Beedrill | Mega | Unchanged | Adaptability | — | Atk +6, Sp.Atk -3, Speed +7 | 93 |
...
| Aggron | Mega | Steel | Filter | — | Atk +3, Def +5, Sp.Def +2 | 279 |
...
| Medicham | Mega | Unchanged | Pure Power | — | Atk +4, Def +1, Sp.Atk +2, Sp.Def +1, Speed +2 | 395 |
...
| Heracross | Mega | Unchanged | Skill Link | — | Atk +6, Def +4, Sp.Def +1, Speed -1 | 687 |
| Sableye | Mega | Unchanged | Magic Bounce | — | Atk +1, Def +5, Sp.Atk +2, Sp.Def +5, Speed -3 | 691 |
...
| Audino | Mega | Normal / Fairy | Healer | — | Def +4, Sp.Atk +2, Sp.Def +4 | 738 |
...
| Metagross | Mega | Unchanged | Tough Claws | — | Atk +1, Def +2, Sp.Atk +1, Sp.Def +2, Speed +4 | 849 |
...
| Rayquaza | Mega | Unchanged | Run Away | — | Atk +3, Def +1, Sp.Atk +3, Sp.Def +1, Speed +2 | 885 |
| Diancie | Mega | Unchanged | Magic Bounce | — | Atk +6, Def -4, Sp.Atk +6, Sp.Def -4, Speed +6 | 930 |

## Primal Reversion

| Species | Type | Added Ability | Extra effect | Stat changes | Source page |
|---|---|---|---|---|---:|
...
These candidates are the original first-pass census. The hardened discovery report in `docs/PTU_FORMS_DISCOVERY.md` supersedes this candidate count for classification and catches embedded/gender/size/color forms.
...
- Absence of dedicated Shiny artwork does not prevent Shiny state; Stage D falls back to the best normal artwork.
