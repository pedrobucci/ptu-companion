...
assert(runtime.includes("else if(id==='hustle')"));assert(runtime.includes('model.accuracyBonus-=2'));assert(runtime.includes('model.damageRollBonus+=10'));assert(runtime.includes("version:'2.2.0-android-beta.21'"));
console.log('PTU Companion Android v2.2.0-beta.21 Hustle equipment mechanics verification: OK');
