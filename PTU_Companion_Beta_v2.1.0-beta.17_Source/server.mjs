...
async function handleApi(req,res,url){
  ...
  if(req.method==='GET' && url.pathname==='/api/health'){
    return json(res,200,{ok:true,version:'2.1.0-beta.17',persistence:'sqlite',database:dbPath,schemaVersion:5,definitions:{database:definitionsPath,persistent:true,activeRuleset:getActiveRuleset()}});
  }
...
server.listen(port,'127.0.0.1',()=>{
  console.log(`PTU Companion Beta v2.1.0-beta.17: http://127.0.0.1:${port}`);
