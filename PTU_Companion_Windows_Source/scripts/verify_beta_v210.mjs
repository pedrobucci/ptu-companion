...
assert(pkg.version==='2.1.0-beta.18','package.json version mismatch');
...
try{
  ...
  assert(health.version==='2.1.0-beta.18','Server health version mismatch');
...
definitions.close();
console.log('PTU Companion Beta v2.1.0-beta.18 verification: OK');
