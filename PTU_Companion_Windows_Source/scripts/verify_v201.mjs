...
assert(pkg.version==='2.1.0-beta.20','package.json version is not the beta version');
...
try{
  const health=await waitServer();assert(health.version==='2.1.0-beta.20','Server health version is not the beta version');
