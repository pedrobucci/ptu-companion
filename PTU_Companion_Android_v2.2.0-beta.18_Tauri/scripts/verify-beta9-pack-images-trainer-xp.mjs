...
const health=await (await fetch('/api/health')).json();if(health.version!=='2.2.0-android-beta.18')throw new Error('Wrong beta.9 health version');
...
console.log('PTU Companion Android v2.2.0-beta.18 pack images + Trainer XP verification: OK');
