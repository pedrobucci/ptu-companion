...
const root=path.resolve(new URL('..',import.meta.url).pathname);const app=fs.readFileSync(path.join(root,'www/app.js'),'utf8');const css=fs.readFileSync(path.join(root,'www/styles.css'),'utf8');const runtime=fs.readFileSync(path.join(root,'www/mobile-runtime.js'),'utf8');
